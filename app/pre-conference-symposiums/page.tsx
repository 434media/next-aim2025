...
export default function PreConferenceSymposiums() {
  ...
  return (
    <>
      <main
        className="min-h-screen bg-white text-neutral-900 pt-24 sm:pt-28"
        id="main-content"
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          {upcomingSymposiums.length > 0 && (
            <motion.section
              className="mt-8 lg:mt-12 space-y-8 lg:space-y-10"
              variants={fadeInUp}
            ...
            >
              ...
              {upcomingSymposiums.map((symposium, index) => (
                <motion.article
                  key={index}
                  className="relative p-6 rounded-lg border border-neutral-200 bg-white/90 backdrop-blur-sm shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-[1.02] hover:-translate-y-1"
                  variants={fadeInUp}
                  custom={index}
                ...
                >
                  <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
                    <div className="space-y-3">
                      <h3 className="text-xl sm:text-2xl font-light group-hover:text-neutral-700 transition-colors text-neutral-900">
                        {symposium.title}
                      </h3>
                      <div className="space-y-2 text-neutral-600">
                        <div className="flex items-center">
                          <RiCalendarLine
                            ...
                            aria-hidden="true"
                          />
                          <span className="text-sm sm:text-base md:text-lg">{symposium.date}</span>
                        </div>
                        <div className="flex items-center">
                          <RiMapPinLine
                            className="mr-3 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-[#548cac]"
                      ...
                      <p className="text-sm sm:text-base md:text-lg text-neutral-600 max-w-prose leading-relaxed">
                    ...
                    <div className="flex-shrink-0 self-start">
                      ...
                      >
                        RSVP
                        <RiArrowRightLine
                          className="ml-2 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 group-hover/button:translate-x-1 transition-transform"
                          aria-hidden="true"
                        />
                      </Button>
                    </div>
