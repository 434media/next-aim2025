...
import { RiCalendarLine, RiMapPinLine, RiTimeLine, RiGroupLine } from "@remixicon/react"
        ...
        <FadeContainer className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="mx-auto max-w-5xl text-center mb-16 sm:mb-20">
            ...
            <h1 className="mb-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
              ...
              <br />
              <span className="text-white/90">Journey Awaits</span>
            </h1>
            ...
            <div className="mx-auto mb-8 flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12">
              <div className="flex items-center justify-center bg-white/5 backdrop-blur-sm rounded-xl px-6 py-4 border border-white/10">
                <RiCalendarLine className="h-6 w-6 mr-3 text-[#548cac] flex-shrink-0" />
                <div className="text-left">
                  <div className="text-lg font-semibold text-white">June 16, 2025</div>
                  <div className="text-sm text-white/70">One Day of Innovation</div>
                </div>
              </div>

              <div className="flex items-center justify-center bg-white/5 backdrop-blur-sm rounded-xl px-6 py-4 border border-white/10">
                <RiMapPinLine className="h-6 w-6 mr-3 text-[#548cac] flex-shrink-0" />
                <div className="text-left">
                  <div className="text-lg font-semibold text-white">San Antonio, TX</div>
                  <div className="text-sm text-white/70">Henry B. González Convention Center</div>
                </div>
              </div>
            </div>

            <FadeDiv className="mx-auto mb-12 max-w-3xl text-lg sm:text-xl text-white/80 leading-relaxed">
              <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="group relative">
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  <RiTimeLine className="h-8 w-8 text-[#548cac] mb-3 mx-auto" />
                  <div className="text-xl font-bold text-white mb-2">20+ Sessions</div>
                  <div className="text-sm text-white/70">Keynotes, panels, and workshops</div>
                </div>
              </div>
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-[#548cac]/20 to-transparent rounded-xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  <RiGroupLine className="h-8 w-8 text-[#548cac] mb-3 mx-auto" />
                  <div className="text-xl font-bold text-white mb-2">5+ Tracks</div>
                  <div className="text-sm text-white/70">Specialized content streams</div>
                </div>
              </div>
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-[#548cac]/20 to-transparent rounded-xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  <RiCalendarLine className="h-8 w-8 text-[#548cac] mb-3 mx-auto" />
                  <div className="text-xl font-bold text-white mb-2">8 Hours</div>
                  <div className="text-sm text-white/70">Of cutting-edge content</div>
                </div>
              </div>
            </div>
          </div>
