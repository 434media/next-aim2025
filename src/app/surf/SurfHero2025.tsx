...
import { RiMicroscopeLine, RiTeamLine, RiBuilding4Line } from "@remixicon/react"
import { presentersData, getCategoryColor } from "@/data/surf-presenters"
                    ...
                    {presentersData.slice(0, 5).map((_, index) => (
                      <motion.div
                        ...
                        className={`h-1 rounded-full transition-all duration-300 ${
                          index === highlightedIndex % 5 ? "bg-[#8ECAE6] w-8" : "bg-white/30 w-2"
                        }`}
                      />
                    ))}
                  </motion.div>
