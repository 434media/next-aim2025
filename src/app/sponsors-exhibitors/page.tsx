...
export default function SponsorsExhibitorsClient() {
  return (
    <div className="bg-[#0a1a2a] min-h-screen pt-24">
      <motion.div
      ...
      >
        ...
        <div className="mb-12 md:mb-16 lg:mb-20">
          ...
          <motion.p className="text-base md:text-lg text-[#a3c2d8] text-center max-w-3xl mx-auto" variants={fadeInUp}>
          ...
          <Suspense
            fallback={
              <div className="w-full h-64 flex flex-col items-center justify-center">
                ...
                <p className="mt-4 text-[#a3c2d8] text-sm">Loading sponsors...</p>
              </div>
            }
          >
            <WhovaSponsorEmbed />
