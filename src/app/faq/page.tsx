...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Refunds are available up to 30 days before the event, minus a processing fee. Please contact the event organizer through the conference app or contact your event POC directly.",
  },
  {
