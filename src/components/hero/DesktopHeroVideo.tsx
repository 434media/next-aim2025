...
export const DesktopHeroVideo = React.memo(({ prefersReducedMotion }: DesktopHeroVideoProps) => {
  ...
  const combinedStickyOpacity = useTransform([stickyTitleOpacity, containerExitProgress], (values) => {
    ...
    // When container is exiting viewport, ensure sticky title fades out
    return exitProgress >= 0.99 ? 0 : opacity
  })
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[80vh] flex flex-row items-stretch overflow-hidden bg-[#101310]"
    ...
    >
      ...
      <motion.div
        className="fixed top-20 left-0 w-1/2 z-30 bg-[#101310]/95 backdrop-blur-sm pointer-events-none"
        style={{
